...
#include "../../HtmlCreator/linkwindow.h"
...
QT_MOC_LITERAL(2, 33, 0) // ""
    ...
    "linkWindow\0on_pushButton_clicked\0"
};
...
void linkWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<linkWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject linkWindow::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_linkWindow.data,
    qt_meta_data_linkWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
