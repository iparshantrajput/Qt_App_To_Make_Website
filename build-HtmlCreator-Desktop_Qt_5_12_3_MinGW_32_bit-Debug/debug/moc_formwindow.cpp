...
#include "../../HtmlCreator/formwindow.h"
...
QT_MOC_LITERAL(2, 33, 0) // ""
    ...
    "formwindow\0on_pushButton_clicked\0"
};
...
void formwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<formwindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject formwindow::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_formwindow.data,
    qt_meta_data_formwindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
